...
try:
    from generate_pdf_report import generate_simple_pdf, DB_CONFIG
except ImportError:
    st.error("⚠️ No se encontró generate_pdf_report.py Asegúrate de tener el archivo en la misma carpeta.")
    st.stop()
